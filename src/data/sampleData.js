...
export const breedingSites = [
  ...
  {id:7,lat:10.6915,lng:122.5580,type:"Tire",status:"Active",risk:"High",reporter:"BHW Maria Santos",date:"2026-10-15",description:"Abandoned tires in vacant lot, heavy larval infestation observed",purok:"Purok 2"},
...
export const cbplaModules = [
  {id:1,title:"Pag-ila sang Dengue",titleEn:"Understanding Dengue",desc:"Ano ang dengue? Paano ini nagakalat? Kilalaha ang mga sintomas, pag-ambit sang klimaw sa pagdagdag sang kaso, kag kun paano magpabulong sa barangay health center.",status:"completed",progress:100,lessons:5,participants:148,avgScore:88},
  {id:2,title:"Pagpangita sang mga Breeding Site",titleEn:"Identifying Breeding Sites",desc:"Turuan mo ang imo kaugalingon nga mag-identify sang mga lugar nga ginapugaran sang lamok sa imo balay kag komunidad. Paggamit sang DengueSHIELD app para sa pag-report.",status:"completed",progress:100,lessons:4,participants:145,avgScore:84},
  {id:3,title:"Aksyon sa Komunidad",titleEn:"Community Action Cycle",desc:"Identify-Plan-Act-Reflect: Paano ang komunidad magbuligay para mapababa ang dengue gamit ang monthly CBPLA cycle kag participatory GIS mapping.",status:"in_progress",progress:65,lessons:6,participants:139,avgScore:76},
  {id:4,title:"Paggamit sang DengueSHIELD App",titleEn:"Using the DengueSHIELD App",desc:"Step-by-step nga pagtudlo sa paggamit sang DengueSHIELD platform para sa pag-report sang breeding sites, pagsulod sang surveillance data, kag pagbasa sang risk alerts.",status:"in_progress",progress:40,lessons:4,participants:132,avgScore:71},
  {id:5,title:"Klima kag Dengue",titleEn:"Climate Change and Dengue",desc:"Paano ang ulan, init, kag humidity nakaapekto sa pagdamo sang lamok kag dengue. Climate-responsive nga mga estratehiya para sa vector control.",status:"locked",progress:0,lessons:3,participants:0,avgScore:0},
];
...
export const projectTimeline = [
  ...
  {phase:"Phase 2",label:"Pilot Testing and Implementation",months:"Months 4-10",status:"in_progress",pct:72},
